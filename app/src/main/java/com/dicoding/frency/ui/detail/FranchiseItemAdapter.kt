...
import com.dicoding.frency.databinding.TypeItemBinding
...
class FranchiseItemAdapter(
    ...
    inner class FranchiseItemViewHolder(val binding: TypeItemBinding) :
        RecyclerView.ViewHolder(binding.root) {

        fun bind(franchiseItem: FranchiseItem) {
            // Bind data ke elemen UI dalam item menggunakan ViewBinding
            binding.tvType.text = franchiseItem.type
